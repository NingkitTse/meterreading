package telecom.sdk.testMessagePush;
...
public class NotifyType {
	...
	// please replace the IP and Port to your localhost IP and port, when you
	// use the testMessagePush.
	public static final String TEST_CALLBACK_BASE_URL = "http://101.132.173.200:12345/mr/telecom/dataReport";
