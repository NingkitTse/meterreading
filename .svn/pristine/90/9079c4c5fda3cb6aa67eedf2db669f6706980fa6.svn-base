...
public class Constant {
    ...
    // please replace the IP and Port of the IoT platform environment address,
    ...
    public static final String APPID = "j9iPSi4dTBEIFG9_Uif5zMisH9ca";
    public static final String SECRET = "GVe0Wex3vMmHJO80jkJSPRx_TM0a";
    // public static final String APPID = "DR3K1UqaJrXTwVuf0K8tP7CojeUa";
    // public static final String SECRET = "Xcto1VMIehReg0ztgKbADI3UAw8a";
     ...
     */
    public static final String CALLBACK_BASE_URL = "http://101.132.173.200:12345/mr/telecom";
    ...
    public static final String DEVICE_ADDED_CALLBACK_URI = "/na/iocm/devNotify/v1.1.0/addDevice";
    ...
    public static final String DEVICE_DELETED_CALLBACK_URI = "/na/iocm/devNotify/v1.1.0/deletedDevice";
    ...
    public static final String REPORT_CMD_EXEC_RESULT_CALLBACK_URI = "/na/iocm/devNotify/v1.1.0/reportCmdExecResult";
    ...
    public static final String APP_AUTH_WITHOUT_BASE = "/iocm/app/sec/v1.1.0/login";
    public static final String REFRESH_TOKEN = BASE_URL + "/iocm/app/sec/v1.1.0/refreshToken";

    /*
     * Device Management: 1. REGISTER_DIRECT_CONNECTED_DEVICE 2.
     * MODIFY_DEVICE_INFO 3. QUERY_DEVICE_ACTIVATION_STATUS 4.
     * DELETE_DIRECT_CONNECTED_DEVICE 5. DISCOVER_INDIRECT_CONNECTED_DEVICE 6.
     * REMOVE_INDIRECT_CONNECTED_DEVICE 7. MODIFY_DEVICE_SHADOW 8.
     * QUERY_DEVICE_SHADOW 9. QUERY_DEVICE_REALTIME_LOCATION
     */
    ...
    /*
     * Batch Task: 1. CREATE_BATCH_TASK 2. QUERY_SPECIFY_TASK 3.
     * QUERY_TASK_DETAILS
     */
    ...
    /*
     * Data Collection: 1. QUERY_SPECIFY_DEVICE 2. QUERY_DEVICES 3.
     * QUERY_DEVICE_HISTORY_DATA 4. QUERY_DEVICE_CAPABILITIES
     */
    ...
    public static final String QUERY_DEVICE_HISTORY_DATA_WITHOUT_BASE = "/iocm/app/data/v1.2.0/deviceDataHistory";
    public static final String QUERY_DEVICE_CAPABILITIES = BASE_URL + "/iocm/app/data/v1.1.0/deviceCapabilities";

    /*
     * Subscription Management: 1. SUBSCRIBE_SERVICE_NOTIFYCATION 2.
     * SUBSCRIBE_MANAGEMENT_NOTIFYCATION 3. QUERY_SPECIFY_SUBSCRIPTION 4.
     * QUERY_BATCH_SUBSCRIPTIONS 5. DELETE_SPECIFY_SUBSCRIPTION 6.
     * DELETE_BATCH_SUBSCRIPTIONS
     */
    ...
    /*
     * Command Delivery: 1. CREATE_DEVICE_CMD 2. QUERY_DEVICE_CMD 3.
     * MODIFY_DEVICE_CMD 4. CREATE_DEVICECMD_CANCEL_TASK 5.
     * QUERY_DEVICECMD_CANCEL_TASK 6. INVOKE_DEVICE_SERVICES
     */
    public static final String CREATE_DEVICE_CMD = BASE_URL + "/iocm/app/cmd/v1.4.0/deviceCommands";
    public static final String CREATE_DEVICE_CMD_WITHOUT_BASE = "/iocm/app/cmd/v1.4.0/deviceCommands";
    ...
    public static final String CREATE_DEVICECMD_CANCEL_TASK_WITHOUT_BASE = "/iocm/app/cmd/v1.4.0/deviceCommandCancelTasks";
    ...
    /*
     * Device Group Management: 1. CREATE_DEVICE_GROUP 2. MODIFY_DEVICE_GROUP 3.
     * DELETE_DEVICE_GROUP 4. QUERY_SPECIFY_DEVICE_GROUP 5. QUERY_DEVICE_GROUPS
     * 6. QUERY_DEVICE_GROUP_MEMBERS 7. ADD_DEVICE_GROUP_MEMBER 8.
     * DELETE_DEVICE_GROUP_MEMBER
     */
    ...
    /*
     * Device Upgrade: 1. CREATE_SW_UPGRADE_TASK 2. CREATE_FW_UPGRADE_TASK 3.
     * QUERY_SPECIFY_PACKAGE 4. QUERY_BATCH_PACKAGES 5. DELETE_SPECIFY_PACKAGE
     * 6. QUERY_SPECIFY_UPGRADE_TASK_RESULT 7. QUERY_UPGRADE_TASKS
     */
    ...
    /*
     * management Notify Type swUpgradeStateChangeNotify|swUpgradeResultNotify|
     * fwUpgradeStateChangeNotify|fwUpgradeResultNotify
     */
