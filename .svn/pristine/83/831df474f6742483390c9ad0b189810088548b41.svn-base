...
public class ParseUtil {
    ...
    public static Integer hexToInt(String str) {
        /* 这是两个为一组的转化，1633转成了2251 其实应该转成5683
     ...
     * 将源水表号编码成帧格式
     * 
     * @param originMeterNo 0013113037027741
     ...
     * @date 2019年12月30日
     */
    public static boolean isFreezenValueValid(FreezeDataValue data) {
        final String freezenValue = data.getFreezenValue();
        if (StringUtils.isEmpty(freezenValue)) {
            return false;
        }
        double value = Double.parseDouble(freezenValue);
        if (value > 4000000) { // FFFFFFFF 为无效数据，除去，这里值已经经过单位转换
            return false;
        }
        return true;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ParseUtil.hexToInt("0c"));
        System.out.println(calcChecksum("6810595650221804000105CEEC011C00"));
