...
public class HttpsUtil {
	...
	public void initSSLConfigForTwoWay() throws Exception {
		...
		selfCert.load(HttpsUtil.class.getClassLoader().getResourceAsStream(selfcertpath),
		...
		caCert.load(HttpsUtil.class.getClassLoader().getResourceAsStream(trustcapath),
				Constant.TRUSTCAPWD.toCharArray());
	...
	public HttpResponse doDeleteWithParas(String url, Map<String, String> queryParams, Map<String, String> headerMap)
			throws Exception {
	...
	public StreamClosedHttpResponse doDeleteWithParasGetStatusLine(String url, Map<String, String> queryParams,
			Map<String, String> headerMap) throws Exception {
