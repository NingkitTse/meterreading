...
public class OneNETUtil {
	...
	public static boolean checkToken(String msg, String nonce, String signature, String token)
		...
		String sig = Base64.encodeBase64String(mdInst.digest(paramB));
		logger.info("url&token validation: result {},  detail receive:{} calculate:{}",
	...
	public static boolean checkSignature(BodyObj obj, String token) {
		...
		logger.info("check signature: result:{}, receive sig:{}, calculate sig: {}",
	 ...
	 *            消息体对象
	 * @param encodeKey
	 *            OneNet平台第三方平台配置页面为用户生成的AES的BASE64编码格式秘钥
	 * @return
