...
/**
 * SubscribeServiceNotification : This interface is used to subscribe service
 * data of IoT platform.
 */
public class SubscribeServiceNotification {
	...
	public static void main(String args[]) throws Exception {
		...
		/*
		 * please replace the notifyType, when you call this interface. service
		 * Notify Type:
		 * deviceAdded|bindDevice|deviceInfoChanged|deviceDataChanged|
		 * deviceDatasChanged|
		 * deviceDeleted|messageConfirm|commandRsp|deviceEvent|
		 * serviceInfoChanged| ruleEvent|deviceModelAdded|deviceModelDeleted|
		 * deviceDesiredPropertiesModifyStatusChanged
		 */
		String notifyType = "deviceDataChanged";

		// Please make sure that the value of callbackurl have been modified in
		// the Constant file.
